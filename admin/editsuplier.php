    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="form-horizontal">
            <?php
            include ('../config/koneksi.php'); 
            $query  = mysqli_query($konek,"SELECT * FROM suplier a LEFT JOIN obat b ON a.kd_obat=b.kd_obat WHERE a.kd_obat=b.kd_obat");
            $data=mysqli_fetch_assoc($query);
            ?>
            <form action="" method="POST">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Kode Suplier</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kd_suplier" value="<?php echo $data['kd_suplier']; ?>"readonly="">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Nama Suplier</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_suplier" value="<?php echo $data['nama_suplier']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Kode Obat</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kd_obat" value="<?php echo $data['kd_obat']; ?>">
                  </div>
                </div>
                <div class="form-group">
...
include("../config/koneksi.php");
  ...
  if(isset($_POST['submit']))
  {
    ...
    mysqli_query($konek,"UPDATE suplier SET nama_suplier = '$nama_suplier', kd_obat = '$kd_obat', alamat = '$alamat', no_tlp = '$no_tlp', email = '$email' WHERE kd_suplier = '$kd_suplier'");
