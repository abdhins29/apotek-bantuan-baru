    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="form-horizontal">
            <?php
            include ('../config/koneksi.php'); 
            $sql = mysqli_query($konek,"SELECT * FROM login WHERE id='$id'");
...
include("../config/koneksi.php");
  ...
  if(isset($_POST['submit']))
  {
    ...
    $edit = mysqli_query($konek,"UPDATE login SET id = '$id', username = '$username', password = '$password', level = '$level' WHERE id = '$id'");
