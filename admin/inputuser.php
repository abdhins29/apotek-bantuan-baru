...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Kelola User</a></li>
            ...
            <form action="" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="username" placeholder="Masukan Username Anda" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">Password</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="password" placeholder="Masukan Password Anda" required="required">
                  </div>
                </div>
                <div class="form-group">
...
include("../config/koneksi.php");
  ...
  if(isset($_POST['submit']))
  {
    ...
    $simpan = mysqli_query($konek,"INSERT INTO login VALUES ('','$username','$password','$level')");
