...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Kelola Kategori</a></li>
            ...
            <form action="" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_kategori" placeholder="Masukan Nama Kategori Anda" required="required">
                  </div>
                </div>
              </div>
...
include("../config/koneksi.php");
  ...
  { $query2 = mysqli_query($konek,"SELECT * FROM kategori ORDER BY kd_kategori DESC");
    $data2 = mysqli_fetch_assoc($query2);
    $jml = mysqli_num_rows($query2);
    if($jml==0){
      $kd_kategori='KT001';
      }else{
        $subid = substr($data2['kd_kategori'],3);
        if($subid>0 && $subid<=8){
          $sub = $subid+1;
          $kd_kategori='KT00'.$sub;
    ...
    $simpan = mysqli_query($konek,"INSERT INTO kategori VALUES ('$kd_kategori','$nama_kategori')");
