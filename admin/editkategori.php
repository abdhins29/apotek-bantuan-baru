    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="form-horizontal">
            <?php
            include ('../config/koneksi.php'); 
            $sql = mysqli_query($konek,"SELECT * FROM kategori WHERE kd_kategori='$kd_kategori'");
            ...
            <form action="" method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="kd_kategori" value="<?php echo $data['kd_kategori']; ?>"readonly="">
                  </div>
                </div>
                <div class="form-group">
...
include("../config/koneksi.php");
  ...
  if(isset($_POST['submit']))
  {
    ...
    $edit = mysqli_query($konek,"UPDATE kategori SET kd_kategori = '$kd_kategori', nama_kategori = '$nama_kategori' WHERE kd_kategori = '$kd_kategori'");
